...
public class RestTestData {
    ...
    public static final Dish DISH_L1=new Dish(10008,"супчик",new BigDecimal(500),10002);
    public static final Dish DISH_L2=new Dish(10009,"мяско",new BigDecimal(500),10002);
    public static final Dish DISH_L3=new Dish(10010,"кролик",new BigDecimal(500),10002);
    public static final Dish DISH_L4=new Dish(10011,"рагу",new BigDecimal(500),10002);
    public static final Dish DISH_C1=new Dish(10012,"еда",new BigDecimal(500),10003);
    public static final Dish DISH_C2=new Dish(10013,"пища",new BigDecimal(500),10003);
    public static final Dish DISH_C3=new Dish(10014,"ролы",new BigDecimal(500),10003);
    public static final Dish DISH_C4=new Dish(10015,"суши",new BigDecimal(500),10003);
    public static final List<Dish>DISH_LIST_L=List.of(DISH_L1,DISH_L2,DISH_L3,DISH_L4);
